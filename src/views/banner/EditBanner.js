...
const EditBanner = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // try {
    //     await firebase.firestore().collection("CarouselImages").doc("HomeScreen").collection("Images").doc(props.location.state.id).update({
      ...
      uploadTask.on(
        ...
        () => {
          uploadTask.snapshot.ref.getDownloadURL().then(async (url) => {
            try {
              await firebase.firestore().collection("BannerAds").doc(props.location.state.id).update({
