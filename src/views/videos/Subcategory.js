      ...
      buttons: [
        {
          label: "Yes",
          onClick: async () => { 
            await firebase.firestore().collection("categories").doc(docid).delete();
                      ...
                      return (
                        <div key={Math.random()}>
                          <CRow>
                            ...
                            <CCol>
                              <CButton style={{ color: "#fff", backgroundColor: "#dc3545", borderColor: "#dc3545", borderRadius: "0.25rem" }} type="button" color="secondary" variant="outline" onClick={() => deleteVideo(item.category, item.id, index)}>Delete</CButton>
                            </CCol>
                          </CRow>
