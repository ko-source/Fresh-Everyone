...
const UnVerifiedServiceProviders = () => {
  ...
  const onExportData = async () => {
    ...
    exportDataToXLSX(filteredData, "UnVerifiedProvidersList");
  };
  ...
  return (
    <CRow>
      ...
      <CCol xl={12}>
        <CCard>
          <CCardHeader color="secondary">UnVerified Providers</CCardHeader>
          <CCardBody>
            <CDataTable
              items={providers}
              loading={loading}
...
export default UnVerifiedServiceProviders;
