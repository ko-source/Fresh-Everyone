...
//   const PriceData = {""}
  ...
  const [socPrice, setPrice] = useState([]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        // socPrice.forEach(async(item)=>{
            await firebase.firestore().collection("hotel").add({
                address:formData.values.address,
                hotelName:formData.values.centerName,
  ...
  return (
    <CCard>
      <CCardHeader style={{ fontWeight: "bold",backgroundColor:"#f7f7f7",fontSize:"1.1rem",color: "black"}} >Add Hotel</CCardHeader>
      <CCardBody>
                        ...
                        <CCol md="10" sm={6}>
                          ...
                          <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                <td><CInput type="checkbox" name="sunday" value="Sunday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="monday" value="Monday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="tuesday" value="Tuesday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="wednesday" value="Wednesday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="thursday" value="Thursday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="friday" value="Friday" onChange={(e)=>checkbox(e)}/></td>
                                <td><CInput type="checkbox" name="saturday" value="Saturday" onChange={(e)=>checkbox(e)}/></td>
                                </tr>
                            </tbody>
                            </table>       
                          </CInputGroup>
