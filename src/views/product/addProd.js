            ...
            uploadTask.on(
              ...
              () => {
                uploadTask.snapshot.ref.getDownloadURL().then(async (url) => {  
                  ...
                  try {
                    await firebase.firestore().collection("productitems")
                    .doc(pId)
                    .set({
                ...
                <CRow className="g-3 align-items-center">
                  ...
                  <CCol sm={4}>
                    <CInput
                      ...
                      placeholder="Enter Product Name"
                      name="discription"
                      value={formData.values.discription}
                      onChange={(e) => {
                        formData.handleChange(e);
